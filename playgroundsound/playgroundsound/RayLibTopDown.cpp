...
//void RayLibTopDown::MoveLight(int slot, float x, float y)
//{
...
//void RayLibTopDown::ComputeShadowVolumeForEdge(int slot, Vector2 sp, Vector2 ep)
//{
...
//void RayLibTopDown::DrawLightMask(int slot)
//{
//    // Use the light mask
...
//
//// Setup a light
//void RayLibTopDown::SetupLight(int slot, float x, float y, float radius)
//{
...
//bool RayLibTopDown::UpdateLight(int slot, Rectangle* boxes, int count)
//{
...
//
//// Set up some boxes
//void RayLibTopDown::SetupBoxes(Rectangle* boxes, int* count)
//{
...
//    {
//        boxes[i] = { (float)GetRandomValue(0,GetScreenWidth()), (float)GetRandomValue(0,GetScreenHeight()), (float)GetRandomValue(10,100), (float)GetRandomValue(10,100) };
//    }
//
//    *count = MAX_BOXES;
//}
...
//        sinValue += 0.03f;
//        
//        float radius = Lerp(0.3,1, fabsf(sinf(sinValue))) * 300;
//        for (auto& light : lights)
//        {
//            light.outerRadius = radius;
//            light.bounds.x = light.position.x - light.outerRadius;
//            light.bounds.y = light.position.y - light.outerRadius;
...
//            for (int i = 0; i < MAX_LIGHTS; i++)
//            {
//                if (lights[i].active) DrawTextureRec(lights[i].mask.texture, { 0, 0, (float)GetScreenWidth(), -(float)GetScreenHeight() }, Vector2Zero(), WHITE);
//            }
//
//            rlDrawRenderBatchActive();
//
...
//        DrawTextureRec(backgroundTexture,  { 0, 0, (float)GetScreenWidth(), (float)GetScreenHeight() }, Vector2Zero(), WHITE);
//
//        // Overlay the shadows from all the lights
//        DrawTextureRec(lightMask.texture,  { 0, 0, (float)GetScreenWidth(), -(float)GetScreenHeight() }, Vector2Zero(), ColorAlpha(WHITE, showLines ? 0.75f : 1.0f));
//
//        // Draw the lights
//        for (int i = 0; i < MAX_LIGHTS; i++)
//        {

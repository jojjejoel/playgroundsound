...
void InputMgr::TranslateInput( void * in_pad, int in_iPlayerIndex )
{
	...
	if (bConnected)
	{
		...
		joysticks[UG_STICKLEFT].x =  (AkReal32)reading.LeftThumbstickX;
		joysticks[UG_STICKLEFT].y =  (AkReal32)reading.LeftThumbstickY;
		joysticks[UG_STICKRIGHT].x = (AkReal32)reading.RightThumbstickX;
		joysticks[UG_STICKRIGHT].y = (AkReal32)reading.RightThumbstickY;
	}
